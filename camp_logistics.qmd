...
ggplot(stayedRV, aes(x = year, y = est, color = labels)) +
  ...
  labs(x = "", y = "Burning Man Partcipants (%)", color = "",
       title = "Did you stay in an RV or camper-trailer in Black Rock City this year, and was it pumped (serviced) on playa?")
...
ggplot(nbfamily, aes(x = year, y = est, color = labels)) +
  ...
  scale_color_manual(values = discreteColors[1:5]) +
  labs(x = "", y = "Burning Man Partcipants (%)", color = "",
       title = "How many of your family members were in Black Rock City this year?")
...
ggplot(placed, aes(x = year, y = est, fill = labels)) +
  ...
  labs(x = "", y = "Burning Man participants (%)", 
       ...
       title = "Was your camp assigned a location by the Burning Man Placement Team before the event?") +
  theme_bw()
...
#                                     "I don\'t know"),
# 
#                          labelOrder = c(4,3,8,6,5,1,2,7,9,10))
# 
...
#   scale_y_continuous(labels = percent) +
# 
#   labs(x = "Number of people in camp", y = "Burning Man participants inn 2022 (%)") +
# 
#   theme_bw() +
# 
#   theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
...
### Where did you get your ticket for the event?
...
#                              years = c(2022),
#                              levels = list(c("2021 Invitation to the Future Ticket",
...
# 
# ggplot(ticketSource[ticketSource$year == 2022,], aes(x = labels, y = est)) +
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Ticket source", y = "Burning Man participants in 2022 (%)") +
#   theme_bw() +
#   coord_flip()
# 
...
#                                                  "More_than_facevalue",
#                                                  "Other")), times = 6),
#                                       list(c("Face value", "Gift/did not pay",
#                                              "Don\'t know", 
