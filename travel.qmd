...
#   labs(x = "Arrival date", y = "Burning Man participants in 2022 (%)") +
#   theme_bw() +
...
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Departure date", y = "Burning Man participants in 2022 (%)") +
#   theme_bw() +
#   theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
# 
...
#   kbl(col.names = c(2018:2019, 2022),
#       row.names = TRUE) |>
#   kable_paper("striped", full_width = F) |>
#   kable_styling() |>
...
#                       levels = c(rep(list("yes"), times = 6), list("Yes")),
...
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Number of people", y = "Burning Man participants who entered through main gate (%)") +
#   theme_bw() 
# 
...
#   scale_fill_manual(values = c("#EA008B", "#FF416f")[2:1]) +
#   scale_color_manual(values = c("#EA008B", "#FF416f")[2:1]) +
#   guides(color = "none") +
...
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Vehicle type", y = "Burning Man participants in 2022 (%)") +
#   theme_bw() +
#   coord_flip()
# 
...
#                         year = c(2022, 2019))
# 
# ggplot(mpg[mpg$year == 2022,], aes(x = mpg, weight = weights)) +
#   geom_density(fill = "#EA008B", alpha = 0.5, bw = 3, linewidth = 1.01) +
#   geom_segment(x = mpg.means$mpg[mpg.means$year == 2022], 
#                xend = mpg.means$mpg[mpg.means$year == 2022],
#                y = 0, yend = 0.0418, color = "#4C4C4C",
#              linewidth = 1.1) +
#   annotate("text", x = 53, y = 0.0418, label = "Average miles per gallon to Black Rock City (18.9 MPG)") +
#   theme_bw(13) +
#   labs(x = "Miles per gallon to Black Rock City in 2022", y = "Density")
# 
...
# 
# fdf <- paste0("%.", 1, "f")
# mpg.mn19 <- paste0(sprintf(fdf, round(mpg.means$mpg[2],1)), " (", 
#                    sprintf(fdf, round(mpg.means$lower[2], 1)), ", ", 
#                    sprintf(fdf, round(mpg.means$upper[2], 1)), ")")
# mpg.mn22 <- paste0(sprintf(fdf, round(mpg.means$mpg[1],1)), " (", 
...
# miles.median <- rbind(med15, med16, med17, med18, med19, med22)
...
# miles.q25 <- rbind(q2515, q2516, q2517, q2518, q2519, q2522)
...
# miles.q75 <- rbind(q7515, q7516, q7517, q7518, q7519, q7522)
...
#                        sprintf(fdf, round(as.numeric(mean22) + 1.965 * sqrt(attr(mean22, "var")), 1)), ")"))
# 
# ggplot(design22$variables, aes(x = miles2, weight = weights)) +
#   geom_density(fill = "#EA008B", alpha = 0.5, bw = 300, linewidth = 1.01) +
#   geom_segment(x = mean22[1], 
#                xend = mean22[1],
...
#   theme_bw(13) +
#   labs(x = "Miles driven to Black Rock City in 2022", y = "Density")
# 
...
<!-- I think there was an issue with this question last year -->
<!-- The code below here for this question does not work -->
...
# 
# bxbroute <- data.frame(total = c(sum(census14$weightbmorg[census14$bxb_sftobrc == "yes" &
# 
#                                                             !is.na(census14$bxb_sftobrc)]),
# 
#                                  sum(census14$weightbmorg[census14$bxb_renotobrc == "yes" &
# 
#                                                             !is.na(census14$bxb_renotobrc)]),
# 
#                                  sum(census14$weightbmorg[census14$bxb_brctosf == "yes" &
# 
#                                                             !is.na(census14$bxb_brctosf)]),
# 
#                                  sum(census14$weightbmorg[census14$bxb_brctoreno == "yes" &
# 
#                                                             !is.na(census14$bxb_brctoreno)]),
# 
#                                  sum(census15$weightbmorg1[census15$bxb_sftobrc == "yes" &
# 
#                                                              !is.na(census15$bxb_sftobrc)]),
# 
#                                  sum(census15$weightbmorg1[census15$bxb_renotobrc == "yes" &
# 
#                                                              !is.na(census15$bxb_renotobrc)]),
# 
#                                  sum(census15$weightbmorg1[census15$bxb_brctosf == "yes" &
# 
#                                                              !is.na(census15$bxb_brctosf)]),
# 
#                                  sum(census15$weightbmorg1[census15$bxb_brctoreno == "yes" &
# 
#                                                              !is.na(census15$bxb_brctoreno)]),
# 
#                                  sum(census16$weightbmorg1[census16$bxb_sftobrc == "yes" &
# 
#                                                              !is.na(census16$bxb_sftobrc)]),
# 
#                                  sum(census16$weightbmorg1[census16$bxb_renotobrc == "yes" &
# 
#                                                              !is.na(census16$bxb_renotobrc)]),
# 
#                                  sum(census16$weightbmorg1[census16$bxb_brctosf == "yes" &
# 
#                                                              !is.na(census16$bxb_brctosf)]),
# 
#                                  sum(census16$weightbmorg1[census16$bxb_brctoreno == "yes" &
# 
#                                                              !is.na(census16$bxb_brctoreno)]),
# 
#                                  sum(census17$weightbfarrival[census17$bxb_sftobrc == "yes" &
# 
#                                                                 !is.na(census17$bxb_sftobrc)]),
# 
#                                  sum(census17$weightbfarrival[census17$bxb_renotobrc == "yes" &
# 
#                                                                 !is.na(census17$bxb_renotobrc)]),
# 
#                                  sum(census17$weightbfarrival[census17$bxb_brctosf == "yes" &
# 
#                                                                 !is.na(census17$bxb_brctosf)]),
# 
#                                  sum(census17$weightbfarrival[census17$bxb_brctoreno == "yes" &
# 
#                                                                 !is.na(census17$bxb_brctoreno)]),
# 
#                                  sum(census18$weightbfarrival[census18$bxb_sftobrc == "yes" &
# 
#                                                                 !is.na(census18$bxb_sftobrc)]),
# 
#                                  sum(census18$weightbfarrival[census18$bxb_renotobrc == "yes" &
# 
#                                                                 !is.na(census18$bxb_renotobrc)]),
# 
#                                  sum(census18$weightbfarrival[census18$bxb_brctosf == "yes" &
# 
#                                                                 !is.na(census18$bxb_brctosf)]),
# 
#                                  sum(census18$weightbfarrival[census18$bxb_brctoreno == "yes" &
# 
#                                                                 !is.na(census18$bxb_brctoreno)]),
# 
#                                  sum(census19$weightbfarrival[census19$bxb_sftobrc == "yes" &
# 
#                                                                 !is.na(census19$bxb_sftobrc)]),
# 
#                                  sum(census19$weightbfarrival[census19$bxb_renotobrc == "yes" &
# 
#                                                                 !is.na(census19$bxb_renotobrc)]),
# 
#                                  sum(census19$weightbfarrival[census19$bxb_brctosf == "yes" &
# 
#                                                                 !is.na(census19$bxb_brctosf)]),
# 
#                                  sum(census19$weightbfarrival[census19$bxb_brctoreno == "yes" &
# 
#                                                                 !is.na(census19$bxb_brctoreno)]),
# 
#                                  sum(census22$weights[census22$BXBRoute.SFToBRC &
# 
#                                                         !is.na(census22$BXBRoute.SFToBRC)]),
# 
#                                  sum(census22$weights[census22$BXBRoute.RenoToBRC &
# 
#                                                         !is.na(census22$BXBRoute.RenoToBRC)]),
# 
#                                  sum(census22$weights[census22$BXBRoute.BRCToSF &
# 
#                                                         !is.na(census22$BXBRoute.BRCToSF)]),
# 
#                                  sum(census22$weights[census22$BXBRoute.BRCToReno &
# 
#                                                         !is.na(census22$BXBRoute.BRCToReno)])),
# 
#                        year = rep(c(2014:2019, 2022), each = 4),
# 
#                        route = rep(c("SF to BRC", "Reno to BRC",
# 
#                                      "BRC to SF", "BRC to Reno"), times = 7),
# 
#                        routeType = rep(c("To BRC", "Leaving BRC"), times = 7, each = 2),
# 
#                        brcpop = rep(c(68000, 70000, 70000, 70000,
# 
#                                       70000, 80000, 87000), each = 4))
# 
# yearSums <- data.frame(yearTotal = c(sum(bxbroute$total[bxbroute$year == 2014]),
# 
#                                      sum(bxbroute$total[bxbroute$year == 2015]),
# 
#                                      sum(bxbroute$total[bxbroute$year == 2016]),
# 
#                                      sum(bxbroute$total[bxbroute$year == 2017]),
# 
#                                      sum(bxbroute$total[bxbroute$year == 2018]),
# 
#                                      sum(bxbroute$total[bxbroute$year == 2019]),
# 
#                                      sum(bxbroute$total[bxbroute$year == 2022])),
# 
#                        year = c(2014:2019, 2022))
# 
# bxbroute <- merge(bxbroute, yearSums, all.x = TRUE, all.y = FALSE)
# 
...
#   scale_y_continuous(labels = percent) +
# 
#   scale_color_manual(values = c("#EA008B", "#FF416f", "#FF7457", "#FFA349", "#FFCF50", "#F9F871")) +
# 
#   guides(color = "none") +
# 
