...
#Color palette (discrete): c("#EA008B", "#BDA5AD", "#FF7457", "#A07200", "#FFCF50", "#554149", "#F9F871")
...
#   labs(x = "", y = "Burning Man Participants in 2022 (%)")
# 
# #This needs to be updated to the more efficient version
# 
...
ggplot(myDat, aes(x = Year, y = Percentage, fill = rows)) + 
  ...
  labs(fill="Number\n of burns\n attended\n (inclusive)") +
  scale_fill_manual(values=c("#EA008B", "#FF416f", "#FF7457", "#FFA349", "#FFCF50")[c(3, 4, 2, 5, 1)])
```
