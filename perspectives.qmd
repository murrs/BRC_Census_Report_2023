...
ggplot(RIDE, aes(x = labels, y = est, fill = as.factor(year))) +
  ...
  labs(x = "R.I.D.E. in BRC", y = "Burning Man participants (%)", 
       fill = "Year",
       title = "How did you see Radical Inclusion, Diversity, and Equity (R.I.D.E.) \n in action while in BRC?") +
  theme_bw() +
  coord_flip() +
  guides(fill = guide_legend(reverse = TRUE))
...
ggplot(diverse, aes(x = labels, y = est, fill = as.factor(year))) +
  ...
  labs(x = "Personal action", y = "Burning Man participants (%)", fill = "Year",
       title = "How did you personally work to create a more diverse and welcoming Black Rock City?") +
  theme_bw() +
  coord_flip() +
  guides(fill = guide_legend(reverse = TRUE))
