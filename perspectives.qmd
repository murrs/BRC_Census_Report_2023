...
ggplot(burnerID, aes(x = year, y = est, fill = labels)) +
  ...
  labs(x = "", y = "Burning Man participants (%)", fill = "Do you identify as a Burner?") +
  theme_bw()
...
# 
# ggplot(prinFreq[prinFreq$year == 2022,], aes(x = labels, y = est)) +
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "10 Principles", y = "Burning Man participants in 2022 (%)") +
#   theme_bw() +
#   coord_flip()
# 
...
### Incorporation of the 10 Principles in the workplace
...
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Incorporation of 10 Principles in your workplace", y = "Burning Man participants in 2022 (%)") +
#   theme_bw()
# 
...
#   labs(x = "Year", y = "Burning Man participants (%)", color = "Brought children?")
# 
...
#   scale_y_continuous(labels = percent, limits = c(0, NA)) +
#   scale_color_manual(values = c("#EA008B", "#FF416f", "#FF7457", "#FFA349")) +
#   labs(x = "Year", y = "Burning Man participants (%)", color = "Age restriction")
# 
...
#                                            design18, design19, design22),
#                             years = c(2015:2019, 2022),
#                             levels = c(as.list(rep("No", times = 5)),
#                                        list("No")),
#                             labels = c("Burners Without Borders",
#                                        "Burning Man Arts",
#                                        "Black Rock Labs (formerly \n Black Rock Solar)",
...
#   scale_y_continuous(labels = percent, limits = c(0, NA)) +
#   scale_color_manual(values = c("#EA008B", "#BDA5AD", "#FF7457")) +
#   labs(x = "", y = "Burning Man participants (%)", color = "Burning Man should be \n involved in year- \n round activities")
# 
...
# donate$year <- factor(donate$year, levels = c(2022, 2019:2015))
...
#                                              "Other")[c(6,10,4,5,3,1,9,7,2,8,11)]))
# 
# donateMean <- rbind(wm22, wm19, wm18, wm17, wm16, wm15)
# 
# 
# ggplot(donate[donate$year == 2022,], aes(x = labels, y = dollars, weight = weights)) +
#   geom_boxplot(width=0.6,  fill = "#EA008B", color = "black",
#                alpha = 0.7) +
#   geom_point(data = donateMean[donateMean$year == 2022,], aes(x = labels, y = est), shape = 23, 
...
### What new sustainability projects did you notice while in BRC in 2022?

```{r}
# sustainabilityNotice <- makePlotData("Emerging sustainability projects are taking center stage in Black Rock City. What new sustainability projects did you notice while in BRC in 2022?",
#                                      varNameTable = varNameTable,
#                                      designs = list(design22),
#                                      years = 2022,
#                                      levels = TRUE,
...
#   scale_y_continuous(labels = percent) +
#   labs(x = "Sustainability projects", y = "Burning Man participants in 2022 (%)", fill = "Year") +
#   theme_bw() +
#   coord_flip()
# 
...
#                                       varNameTable = varNameTable,
#                                       design = list(design22),
#                                       years = 2022,
#                                       levels = TRUE,
#                                       labels = c("How did you begin to \n address sustainability \n in Black Rock City?",
#                                                  "I purchased carbon offsets \n to offset my travel \n to and from BRC",
#                                                  "I have a container with the BRC storage \n program or store camp materials close \n to BRC in another location",
#                                                  "I am a member of a camp that \n creates sustainability-related content \n for other participants to experience",
...
#                                                  "I participated in the resource- \n sharing system HUBS (Humans Uniting \n for Better Sustainability)",
#                                                  "I used renewable energy at \n my camp or project",
#                                                  "I had a waste-reduction plan \n with my camp or crew",
#                                                  "I minimized food waste by \n planning carefully, feeding others, \n and/or composting",
#                                                  "I collected my greywater to \n be repurposed",
#                                                  "I reduced the use of single-use \n plastic for drinking water and \n other consumable items",
#                                                  "I removed and recycled packaging \n before arriving in \n Black Rock City",
#                                                  "I planned ahead and disposed of \n waste appropriately when leaving \n Black Rock City, including collecting \n items for recycling off playa",
#                                                  "I actively helped others \n learn to reduce their \n environmental impact",
#                                                  "I brought my aluminum cans \n to Recycle Camp",
#                                                  "I engaged in Leave No Trace \n and did more MOOP sweeps \n on playa",
#                                                  "Other",
#                                                  "I haven\'t done any of this"),
#                                       labelOrder = c(22,21,5,9,2,1,4,17,7,3,11,13,18,8,6,10,16,19,12,14,15))
# 
...
```{r}
# sustainabilityImportant <- makePlotData("How important to you is it that Burning Man Project visibly engages in best practices in environmental sustainability?",
#                                         varNameTable = varNameTable,
#                                         designs = list(design22),
#                                         years = 2022,
#                                         levels = c("Essential", 
...
#   geom_bar(stat = "identity", fill = "#EA008B", position = "dodge") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Importance", y = "Burning Man participants in 2022 (%)", fill = "Year") +
#   theme_bw()
# 
...
```{r}
# RIDE <- makePlotData("How did you see Radical Inclusion, Diversity, and Equity (R.I.D.E.) in action while in BRC in 2022?",
#                      varNameTable = varNameTable,
#                      designs = list(design22),
#                      levels = TRUE,
#                      years = 2022,
...
#   geom_bar(stat = "identity", fill = "#EA008B", position = "dodge") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "R.I.D.E. in BRC", y = "Burning Man participants in 2022 (%)", fill = "Year") +
#   theme_bw() +
#   coord_flip()
# 
...
#   geom_bar(stat = "identity", fill = "#EA008B", position = "dodge") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Personal action", y = "Burning Man participants in 2022 (%)", fill = "Year") +
#   theme_bw() +
#   coord_flip()
# 
