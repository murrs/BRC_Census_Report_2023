...
attendRegional$attend <- rep(c("Attended or volunteered \n with a regional event", 
                               "Did not attend a \n regional event", 
                               "Did not attend a \n regional event", 
                               "Attended a regional"), times = 9)
...
BMMedia2 <- BMMedia
#Need to specify level order.  I'll do this later
